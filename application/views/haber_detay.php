        ...
        <section>
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-1">
                        <div class="mb-2">
                            <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="<?php echo $this->lang->line('dinle')?>">
                        ...
                        <div class="mb-2">
                            <button type="button" id="like-button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="<?php echo $this->lang->line('begen')?>">
                            ...
                            </button><span id="likes-count" class="badge badge-pill badge-primary ml-2 position-absolute"> <?=$haber_icerik->row()->id?></span>
                        </div>
                        <div class="mb-2">
                            <button type="button" id="dislike-button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="<?php echo $this->lang->line('begenme')?>">
                        ...
                        <div class="mb-2">
                            <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="<?php echo $this->lang->line('yorumlari_gor')?>">
                        ...
                        <div class="mb-2">
                            <button type="button" class="btn btn-secondary" data-toggle="tooltip" data-placement="right" title="<?php echo $this->lang->line('paylas')?>">
                    ...
                    <div class="col-lg-8">
                        <div class="bg-dark p-3 rounded">
                            <img src="../../images/n-ikon.webp" class="img-fluid"> <span class="font-weight-bold text-white"><?=$haber_icerik->row()->kaynak?></span>
                            <button class="btn btn-sm btn-light ml-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus" viewBox="0 0 16 16">
                                    <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                </svg> <?php echo $this->lang->line('takip')?>
                            </button>
                            <div class="text-light float-right small">
                                <span class="text-white font-weight-bold">1.2M </span> <?php echo $this->lang->line('takipci')?>
                        ...
                        <?php
                            ...
                            $ozet = "ozet_".$this->session->userdata('site_lang');
                            $aciklama = "aciklama_".$this->session->userdata('site_lang');
                        ?>

                        <div class="my-3">
                            <div>
                                <h2><?=$haber_icerik->row()->$baslik?></h2>
                            </div>
                            <div class="d-flex border-bottom border-dark pb-3">
                                <div><?php echo $this->lang->line('yazan')?> <?=$haber_icerik->row()->yazar?>;</div>
                                <div>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                                        <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"/>
                                    </svg>
                                    <?=date("d.m.Y", strtotime($haber_icerik->row()->tarih))?>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-dot" viewBox="0 0 16 16">
                                        <path d="M8 9.5a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3"/>
                                    </svg>
                                </div>
                            ...
                            <img src="<?=site_url() . $haber_icerik->row()->resim; ?>" class="w-100 d-block my-3">
                            <small>
                                <?=$haber_icerik->row()->$ozet?>
                                <br>
                            </small>
                            <?=$haber_icerik->row()->$aciklama?>
                        </div>
                    </div>
                    <div class="col-lg-3">
                        <div class="card d-block bg-transparent p-3">
                            <img src="../../images/n-ikon.webp" class="rounded-circle mb-2">
                            <a href="https://www.newsweek.com/"><?php echo $this->lang->line('ziyaret')?>; <?=$haber_icerik->row()->kaynak?></a>
                            ...
                            <ul class="list-group">
                                <li class="list-group-item bg-transparent text-truncate">
                                    Aileen Cannon Playing 'Dangerous Game' in Donald Trump Trial: Attorney
                                </li>
                                <li class="list-group-item bg-transparent text-truncate">
                                    China Claims Arrest of Spies Turned by US Ally
                                </li>
                                <li class="list-group-item bg-transparent text-truncate">Women Turn Up at Airport for Flight, Make Embarrassing Realization/li>
                            </ul>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            $('#like-button').click(function() {
                $.ajax({
                    url: '<?php echo site_url($this->session->userdata('site_lang').'/haberler/like/' . $haber_icerik->row()->id); ?>',
                    type: 'POST',
            ...
            $('#dislike-button').click(function() {
                $.ajax({
                    url: '<?php echo site_url($this->session->userdata('site_lang').'/haberler/dislike/' . $haber_icerik->row()->id); ?>',
                    type: 'POST',
                    success: function(data) {
                        var result = JSON.parse(data);
                        if (result.success) {
