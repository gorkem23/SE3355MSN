            ...
            <div class="container">
                <div class="row">
                    ...
                    <?php if (!empty($sonuclar)) : ?>
                        <ul>
                            <?php foreach ($sonuclar as $haber) : ?>
                                <li><?php echo $haber->baslik_tr; ?> - <?php echo $haber->aciklama_tr; ?></li>
                            <?php endforeach; ?>
                        </ul>
                    <?php else : ?>
                        <p class="alert alert-warning text-center">Hiçbir sonuç bulunamadı.</p>
                    <?php endif; ?>
                    </div>
                </div>
            </div>
