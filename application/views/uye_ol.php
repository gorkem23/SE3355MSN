		...
		<section>
			<div class="container mt-5">
				<div class="col-lg-12 text-center">
					<h2><?php echo $this->lang->line('uye_ol'); ?></h2>
				</div>
				<div class="col-lg-8 mx-auto mt-5">
					<?php echo validation_errors(); ?>
					<form action="<?php echo site_url($this->session->userdata('site_lang') .'/uye_ol'); ?>" method="post">
						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="ad"><?php echo $this->lang->line('ad'); ?>:</label></div>
							<div class="col-lg-6"><input id="ad" type="text" name="ad" class="form-control"/></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="soyad"><?php echo $this->lang->line('soyad'); ?>:</label></div>
							<div class="col-lg-6"><input id="soyad" type="text" name="soyad" class="form-control" /></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="email"><?php echo $this->lang->line('email'); ?>:</label></div>
							<div class="col-lg-6"><input id="email" type="text" name="email" class="form-control" /></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="ulke"><?php echo $this->lang->line('ulke'); ?>:</label></div>
							<div class="col-lg-6"><input id="ulke" type="text" name="ulke" class="form-control" /></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="sehir"><?php echo $this->lang->line('sehir'); ?>:</label></div>
							<div class="col-lg-6"><input id="sehir" type="text" name="sehir" class="form-control" /></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="sifre"><?php echo $this->lang->line('sifre'); ?>:</label></div>
							<div class="col-lg-6"><input id="sifre" type="password" name="sifre" class="form-control" /></div>
						</div>

						<div class="form-row mb-3">
							<div class="col-lg-6"><label for="sifre_tekrar"><?php echo $this->lang->line('sifre_tekrar'); ?>:</label></div>
							<div class="col-lg-6"><input id="sifre_tekrar" type="password" name="sifre_tekrar" class="form-control" /></div>
						</div>
                        <div class="float-left mt-4">
                            <a href="<?php echo site_url($this->session->userdata('site_lang') .'/giris'); ?>">
                                <?php echo $this->lang->line('kayitli_giris')?><!-- language -->
                            </a>
                        </div>
						<div class="float-right mt-4">
							<button type="submit" class="btn btn-dark"><?php echo $this->lang->line('uye_ol'); ?></button>
						</div>
